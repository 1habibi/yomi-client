export { AnimeDetail } from "./components/anime-detail";
export { AnimeDetailHero } from "./components/anime-detail-hero";
export { AnimePlayer } from "./components/anime-player";
